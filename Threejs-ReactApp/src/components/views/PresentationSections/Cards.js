          ...
          <Container fluid>
            <Row>
              <Col
                ...
                xs="12"
              >
                <h1 className="title">Dynamic 3D Elements</h1>
                <h3 className="category text-info">
                  <strong>A SINGLE ELEMENT FOR EVERY INTERACTION</strong>
                </h3>
                <p className="description">
                  Cards are versatile, but we take it a step further with
                  dynamic 3D elements designed for various use-cases within your
                  GLB viewer. From product showcases to interactive tooltips,
                  our elements are versatile and engaging. Each is crafted to
                  align with our Space Gray aesthetic and optimized for user
                  engagement.
                </p>
              </Col>
              <Col md={12}>
